    ...
    class DIPI_Settings
    {
        ...
        private function create_general_tab_fields()
        {
            return [
                ...
                //    'description' => sprintf(esc_html__('My template with %1$s. Cool, eh?', 'dipi-divi-pixel'), sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_preloader" target="_blank">%1$s</a>', esc_html__('Link', 'dipi-divi-pixel'))),
                //   'type' => 'text',
                //    'tab' => 'general',
                //    'section' => 'general',
                //    'toggle' => 'test',
                    ...
                    'description' =>  
                        sprintf(
                            esc_html__('This options adds a moving particles background effect to any element, you can customize them using Divi Pixel %1$s', 'dipi-divi-pixel'),
                                    sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_particles" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'))
                                ),
                   'type' => 'checkbox',
                    'tab' => 'general',
                    'new' => true,
                ...
                'login_page' => [
                    ...
                    'description' => sprintf(esc_html__('Enable this option to customize login page. You can change logo, style form, login button and more. To customize login page go to Divi Pixel %1$s', 'dipi-divi-pixel'), sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_login_page&url=%2$s" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'), rawurlencode(wp_login_url()))),
                    'type' => 'checkbox',
                    'tab' => 'general',
                    'section' => 'general',
                    'toggle' => 'login_page'
                ...
                'browser_scrollbar' => [
                    ...
                    'description' => sprintf(esc_html__('Enable this option to customize browser scrollbar. You can change style and colors in %1$s', 'dipi-divi-pixel'), sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_browser_scrollbar" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'))),
                    'type' => 'checkbox',
                    'tab' => 'general',
                    'section' => 'general',
                ...
                'show_clear_divi_cache_in_adminbar_only_admin' => [
                    'label' => esc_html__('Only Admin', 'dipi-divi-pixel'),
                    'description' => esc_html__('Show Clear Divi Cache menu in admin bar only admin', 'dipi-divi-pixel'),
                    'type' => 'checkbox',
                    'tab' => 'general',
                    'section' => 'general',
                    'toggle' => 'show_clear_divi_cache_in_adminbar',
                ...
                'enable_clear_cache_on_schedule' => [
                    'label' => esc_html__('Enable Clear Divi Cache on Schedule', 'dipi-divi-pixel'),
                    'description' => esc_html__('Enable clear static resources cache on a schedule', 'dipi-divi-pixel'),
                    'type' => 'checkbox',
                    'tab' => 'general',
                    'section' => 'general',
                    'toggle' => 'show_clear_divi_cache_in_adminbar',
                ...
                'clear_cache_schedule' => [
                    'label' => esc_html__('Clear Divi Cache Schedule', 'dipi-divi-pixel'),
                    'description' => esc_html__('Select the recurrence pattern that triggers the clear static resources cache operation repeatedly.', 'dipi-divi-pixel'),
                    'type' => 'select',
                    'tab' => 'general',
                    'section' => 'general',
                    'toggle' => 'show_clear_divi_cache_in_adminbar',
                ...
                'enable_clear_cache_on_wp_hook' => [
                    'label' => esc_html__('Clear Divi Cache on WordPress Hook', 'dipi-divi-pixel'),
                    'description' => esc_html__('Enable this option to fire clear static resources cache on the selected WordPress hook.', 'dipi-divi-pixel'),
                    'type' => 'checkbox',
                    'tab' => 'general',
                    'section' => 'general',
                    'toggle' => 'show_clear_divi_cache_in_adminbar',
                ...
                'clear_cache_on_wp_hook' => [
                    'label' => esc_html__('WordPress hook', 'dipi-divi-pixel'),
                    'description' => esc_html__('Select WordPress hook that triggers the clear static resources cache operation.', 'dipi-divi-pixel'),
                    'type' => 'select2',
                    'placeholder' => esc_html__('Select Hooks', 'dipi-divi-pixel'),
                    'tab' => 'general',
                    'section' => 'general',
                    'toggle' => 'show_clear_divi_cache_in_adminbar',
                    'default' => ['after_post_save'],
                    'options' => [
                        'after_plugin_update' => esc_html__('After Plugin Update', 'dipi-divi-pixel'),  
                        'after_theme_update' => esc_html__('After Theme Update', 'dipi-divi-pixel'),
                        'after_vb_exits' => esc_html__('After Exiting Visual Builder', 'dipi-divi-pixel'),
                        'after_post_save' => esc_html__('After Post Save', 'dipi-divi-pixel')
                    ],
                    'show_if' => [
        ...
        private function create_blog_tab_fields()
        {
            return [
                ...
                'blog_meta_icons' => [
                    ...
                    'description' => sprintf(
                        esc_html__('Enable this option to add date, author and comments icons to meta text and customize them using Divi Pixel %1$s', 'dipi-divi-pixel'),
                                            sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_blog_archives" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'))
                                        ),
                    'type' => 'checkbox',
                    'tab' => 'blog',
                    'section' => 'blog_general',
                ...
                'add_read_more_archive' => [
                    ...
                    'description' => sprintf(esc_html__('Add Read More button to single posts on archive pages. To customize single blog post button go to Divi Pixel %1$s', 'dipi-divi-pixel'), sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_blog_archives_btn" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'))),
                    'type' => 'checkbox',
                    'tab' => 'blog',
                    'section' => 'blog_general',
                ...
                'author_box' => [
                    ...
                    'description' => sprintf(esc_html__('Enable this option to add author box below posts and customize it using Divi Pixel %1$s', 'dipi-divi-pixel'), sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_blog_author_box" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'))),
                    'type' => 'checkbox',
                    'tab' => 'blog',
                    'section' => 'blog_general',
                    'toggle' => 'author_box',
                ...
                'blog_nav' => [
                    ...
                    'description' => sprintf(esc_html__('Enable this option to display prev/next links below posts and customize it using Divi Pixel %1$s', 'dipi-divi-pixel'), sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_blog_navigation" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'))),
                    'type' => 'checkbox',
                    'tab' => 'blog',
                    'section' => 'blog_general',
                    'toggle' => 'blog_nav',
                ...
                'related_articles' => [
                    ...
                    'description' => sprintf(esc_html__('Enable this option to display Related Articles below posts and customize it using Divi Pixel %1$s', 'dipi-divi-pixel'), sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_blog_related_posts" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'))),
                    'type' => 'checkbox',
                    'tab' => 'blog',
                    'section' => 'blog_general',
                ...
                'enable_custom_comments' => [
                    ...
                    'description' => sprintf(esc_html__('Enable this option to customize blog post comments section. To change form appearance go to Divi Pixel %1$s', 'dipi-divi-pixel'), sprintf('<a href="customize.php?autofocus[section]=dipi_customizer_section_blog_comments" target="_blank">%1$s</a>', esc_html__('Theme Customizer', 'dipi-divi-pixel'))),
                    'type' => 'checkbox',
                    'tab' => 'blog',
                    'section' => 'blog_general',
        ...
        private function create_mobile_tab_fields()
        {
            return [
                ...
                'popup_as_mobile_menu' => [
                    'label' => esc_html__('Use Popup as Mobile Menu', 'dipi-divi-pixel'),
                    'description' => esc_html__('Enable this option to use popup as mobile menu.', 'dipi-divi-pixel'),
                    'type' => 'checkbox',
                    'tab' => 'mobile',
                    'section' => 'mobile_menu',
                    'toggle' => 'mobile_menu_style',
                ...
                'mobile_menu_popup' => [
                    'label' => esc_html__('Select Popup', 'dipi-divi-pixel'),
                    'description' => esc_html__('Select specific popup to opne when click on mobile menu.', 'dipi-divi-pixel'),
                    'type' => 'select',
                    'tab' => 'mobile',
                    'section' => 'mobile_menu',
                    'toggle' => 'mobile_menu_style',
                ...
                'popup_select_menu' => [
                    'label' => esc_html__('Select Menu', 'dipi-divi-pixel'),
                    'description' => esc_html__('Select specific menu to display popup.', 'dipi-divi-pixel'),
                    'type' => 'select2',
                    'tab' => 'mobile',
                    'section' => 'mobile_menu',
                    'toggle' => 'mobile_menu_style',
                ...
                'hamburger_animation' => [
                    'label' => esc_html__('Hamburger Customization', 'dipi-divi-pixel'),
                    'description' => esc_html__('Enable this option to customize the mobile menu icon.', 'dipi-divi-pixel'),                
                    'type' => 'checkbox',
                    'tab' => 'mobile',
                    'section' => 'mobile_menu',
                ...
                'hamburger_animation_styles' => [
                    'label' => esc_html__('Hamburger Animation Style', 'dipi-divi-pixel'),
        ...
        private function create_social_media_tab_fields()
        {
            $fields = [
                ...
                'enable_social_icons_multiple_menus' => [
                    'label' => esc_html__('Show in Multiple Menus', 'dipi-divi-pixel'),
                    'description' => esc_html__('Enable this option to allow the icons in multiple menus.', 'dipi-divi-pixel'),
                    'type' => 'checkbox',
                    'options' => [
                        'off' => esc_html__('No', 'dipi-divi-pixel'),
                        'on' => esc_html__('Yes', 'dipi-divi-pixel'),
                ...
                'social_icons_multiple_menus' => [
                    'label' => esc_html__('Select Menu', 'dipi-divi-pixel'),
                    'description' => esc_html__('Select specific menu to display social icons', 'dipi-divi-pixel'),
                    'type' => 'select2',
                    'tab' => 'social_media',
                    'section' => 'social_media_general',
                    'toggle' => 'social_media_general',
        ...
        public function get_pages()
        {
            if (is_null($this->pages)) {
                $this->pages = $this->get_posttype_list('page');
            }
            return $this->pages;
        }
        public function get_popups()
        {
            if (!isset($this->popups) || is_null($this->popups)) {
                $this->popups = $this->get_posttype_list('dipi_popup_maker');
            }
            return $this->popups;
        }

        protected function get_posttype_list($post_type) {
            global $wpdb;

            $list = [0 => esc_html__('-- Select Item --', 'dipi-divi-pixel')];
            ...
            foreach ($results as $post) {
                $list[$post->ID] = !empty($post->post_title) 
                    ? $post->post_title 
                    : esc_html__('(no title)', 'dipi-divi-pixel');
            }
